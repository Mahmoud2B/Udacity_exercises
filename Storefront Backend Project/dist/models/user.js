...
var UserStore = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_1 = _a.sent();
                        throw new Error("Can't retrieve users! ".concat(err_1));
    ...
    UserStore.prototype.create = function (user) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            var conn, hash, sql, result, error_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        error_1 = _b.sent();
                        throw new Error("Can't Create user! ".concat(error_1));
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_2 = _a.sent();
                        throw new Error("Something went wrong ".concat(error_2));
                    case 4: return [2 /*return*/];
                }
            });
        });
