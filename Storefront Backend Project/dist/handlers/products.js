...
var authToken_1 = __importDefault(require("../middlewares/authToken"));
...
var create = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var name, price, categoryId, product, createdProduct, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                name = req.body.name;
...
var products_routes = function (app) {
    ...
    app.post('/products/create', authToken_1.default, create);
